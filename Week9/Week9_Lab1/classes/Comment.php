...
class Comment {
  ...
  public function getComments() {
    $sql = "SELECT c.ID AS CID, u.ID AS UID, c.comment_text, c.date_created, u.user_name, c.comment_user FROM comments c JOIN users u ON u.ID = c.comment_user WHERE c.comment_post = ? AND c.comment_parent IS NULL ORDER BY c.date_created DESC";
